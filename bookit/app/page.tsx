...
export default function Home() {
  return (
    <div className="relative">
        ...
        <div className="relative hero-content text-center mx-4 lg:mx-[15%] py-20">
          <div className="max-w-lg">
            ...
            <ul className="steps steps-vertical lg:steps-horizontal">
              ...
              <li className="step step-secondary text-sm">
                <div className="badge">Réserver votre salle</div>
              </li>
              <li className="step step-secondary text-sm">
                <div className="badge">Gérer vos réservations</div>
              </li>
            </ul>
      ...
      <footer className="text-center items-center bg-base-200 text-base-centent mt-20 py-5 px-10">
        <h1>Bookit &copy; 2025 - Tous droits réservés </h1>
      </footer>
